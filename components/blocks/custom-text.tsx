...
const CustomText : React.FC<Props> = ({title}) => {
    return ( 
         <span 
        className="bg-gradient-to-br dark:from-zinc-100 from-black from-30% dark:to-zinc-100/40 to-black/40 bg-clip-text font-display text-center text-4xl font-bold my-7 tracking-normal text-black dark:text-zinc-100 md:text-7xl md:leading-[5rem]"
